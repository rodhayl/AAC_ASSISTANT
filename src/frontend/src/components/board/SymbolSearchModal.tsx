    ...
    <Dialog open onOpenChange={(open) => { if (!open) onClose(); }}>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button onClick={onClose} aria-label={t('close')} className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 border-b border-border dark:border-white/5 bg-gray-50 dark:bg-white/5 space-y-3">
          ...
          <div className="flex gap-3">
            <div className="flex-1 relative">
              <Filter className="absolute left-2.5 top-2.5 w-4 h-4 text-gray-400 dark:text-gray-500 pointer-events-none z-10" />
              <Select
            ...
            <div className="flex-1 relative">
              <Globe className="absolute left-2.5 top-2.5 w-4 h-4 text-gray-400 dark:text-gray-500 pointer-events-none z-10" />
              <Select
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-gray-100 dark:bg-gray-900/50 rounded-b-xl">
