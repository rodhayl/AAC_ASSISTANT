...
5. Frozen runtime layout and static packaging guardrails
...
class TestFrozenRuntime:
    ...
    def test_frozen_installed_runtime_uses_appdata_for_writable_files(self, tmp_path):
    ...
    def test_frozen_portable_runtime_keeps_data_beside_executable(self, tmp_path):
    ...
    def test_bundled_ngrams_resolve_from_meipass(self, monkeypatch, tmp_path):
    ...
    def test_companion_templates_use_bundled_resource_path(self, monkeypatch, tmp_path):
    ...
    def test_packaging_scripts_describe_slim_unattended_build(self):
